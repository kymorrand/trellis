...
def load_soul_local(agent_name: str = "ivy", agents_dir: str = "agents") -> str:
    ...
    condensed += (
        ...
        "\n\n"
        "You do not have access to tools in this conversation. Do not claim to "
        "perform actions like taking screenshots, searching the web, searching "
        "the vault, executing commands, or dispatching tasks. You cannot search "
        "the vault, execute commands, dispatch Armando, or approve queue items. "
        "If the user needs tool access, suggest they prefix with /claude."
        "\n\n"
