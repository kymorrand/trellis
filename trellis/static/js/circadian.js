...
const PHASES = {
  ...
  afternoon: {
    ...
    cloud:        'oklch(95% 0.02 78)',
    'cloud-dim':  'oklch(90% 0.025 72)',
    earth:        'oklch(28% 0.04 50)',
    'earth-light':'oklch(40% 0.04 52)',
  },
  evening: {
    sky:          'oklch(68% 0.09 45)',
    leaf:         'oklch(52% 0.12 135)',
    'leaf-light': 'oklch(62% 0.11 130)',
    'leaf-dark':  'oklch(38% 0.10 142)',
    wood:         'oklch(45% 0.08 50)',
    'wood-light': 'oklch(58% 0.07 55)',
    solar:        'oklch(52% 0.06 228)',
    ivy:          'oklch(65% 0.07 210)',
    'wf-yellow':  'oklch(72% 0.13 80)',
    'wf-red':     'oklch(50% 0.14 22)',
    'wf-purple':  'oklch(48% 0.10 305)',
    cloud:        'oklch(88% 0.03 70)',
    'cloud-dim':  'oklch(82% 0.03 65)',
    earth:        'oklch(26% 0.04 48)',
    'earth-light':'oklch(38% 0.04 48)',
  },
  night: {
    ...
    cloud:        'oklch(22% 0.02 55)',
    'cloud-dim':  'oklch(18% 0.02 50)',
...
function generateBgKeyframes(phasePcts) {
  ...
  const bgValues = {
    ...
    evening:   ['oklch(45% 0.025 55)', 'oklch(38% 0.02 50)'],
  };
